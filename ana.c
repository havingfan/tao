...
int ana(){
  ...
  TH1I *h11 = new TH1I( "h11", "The Pt(nu_tau) distribution", 30, 0, 3);
  TH1I *h12 = new TH1I( "h12", "The Pt(pi) distribution", 30, 0, 3);
  TH1I *h21 = new TH1I( "h21", "The Eta(nu_tau) distribution", 40, -4, 4);
  TH1I *h22 = new TH1I( "h22", "The Eta(pi) distribution", 40, -4, 4);
  TH1I *h31 = new TH1I( "h31", "The Phi(nu_tau) distribution", 40, -4, 4);
  TH1I *h32 = new TH1I( "h32", "The Phi(pi) distribution", 40, -4, 4);
  TH1I *h41 = new TH1I( "h41", "The E(nu_tau) distribution", 35, 0, 3.5);
  TH1I *h42 = new TH1I( "h42", "The E(pi) distribution", 35, 0, 3.5);
